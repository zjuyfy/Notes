        ...
        \begin{document}
          ...
          %
            ...
            \begin{deduce}
                在晶体的周期势
                \begin{equation}
                    U(\vec r+\vec R)=U(\vec r),\quad\quad\text{，其中\(\vec R\)代表所有布拉维格子的格矢}
                \end{equation}
                代入薛定谔方程
                \begin{equation}
                    H \psi=\left(-\frac{\hbar^2}{2 m} \nabla^2+U(\vec{r})\right) \psi=\varepsilon \psi
                \end{equation}
            ...
            \begin{theorem}
                \hl{布洛赫定理}：
                \begin{equation}
                    \psi_{n k}(\vec{r}+\vec{R})=e^{i \vec{k} \cdot \vec{R}} \psi_{n k}(\vec{r})
                \end{equation}
            \end{theorem}
